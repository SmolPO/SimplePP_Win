...
*/
 ...
 // Cport[comport_number] = open(comports[comport_number], O_RDWR | O_NOCTTY | O_NDELAY);
  Cport[comport_number] = open(com_port, O_RDWR | O_NOCTTY | O_NDELAY);
...
/* http://man7.org/linux/man-pages/man4/tty_ioctl.4.html */
  ...
  ///тест
  char* wow = "wow\0";
  RS232_SendBuf(Cport[comport_number], wow,strlen(wow));
  ///тест
  return(0);
}
...
//  ReadFile(Cport[comport_number], buf, size, (LPDWORD)((void *)&n), NULL);
    ReadFile(com_port, buf, size, (LPDWORD)((void *)&n), NULL);
  return(n);
}
